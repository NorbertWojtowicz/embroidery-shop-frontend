        ...
        <div>
            ...
            <section className="panel">
                <div className="list-group">
                    <a className="list-group-item category-header-wrapper">
                        <h5 className="category-header">Kategorie</h5>
                    </a>
                    {
                        categories.map(category =>
                            <a onClick={setActive} key={category.categoryId} className="list-group-item list-group-item-action">
