...
const ProductDetails = () => {
        ...
        await axios.post(`http://localhost:8080/cart/add/${id}/${quantity}`, {},
            ...
            .catch(err => {
                if (err.response.status === 401) {
                    ...
                    setMessages({
                        error: errMessage === "No message available" ? "Coś poszło nie tak..." : errMessage,
                        success: ""
                    });
                }
            });
    ...
    return (
            <div className="p-4">
                ...
                {messages.success !== "" ? <SuccessMessage message={messages.success}/> : ""}
                {product.isLoaded ?
                            <div className="product-details-wrapper">
                                ...
                                <div className="details-container">
                                    ...
                                    <form className="d-flex justify-content-left top-margin-2 details-form">
                                        <input type="number" aria-label="Search" name="quantity" defaultValue="1"
                                               className="form-control quantity-input"/>
                                        <button className="btn btn-add-to-cart btn-primary btn-md my-0 p" type="submit"
